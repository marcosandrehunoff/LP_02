object DmDados: TDmDados
  ...
  object QryPais: TFDQuery
    AfterInsert = QryPaisAfterInsert
    OnUpdateError = QryPaisUpdateError
    Connection = DmConexao.FDConexao
    UpdateOptions.AssignedValues = [uvFetchGeneratorsPoint, uvGeneratorName]
    UpdateOptions.FetchGeneratorsPoint = gpImmediate
    UpdateOptions.GeneratorName = 'SEQ_PAI_CODIGO'
    UpdateOptions.AutoIncFields = 'PAI_CODIGO'
    SQL.Strings = (
  ...
  object QryClube: TFDQuery
    AfterInsert = QryClubeAfterInsert
    OnUpdateError = QryClubeUpdateError
    Connection = DmConexao.FDConexao
    UpdateOptions.AssignedValues = [uvFetchGeneratorsPoint, uvGeneratorName]
    UpdateOptions.FetchGeneratorsPoint = gpImmediate
  ...
  object QryTatica: TFDQuery
    AfterInsert = QryTaticaAfterInsert
    OnUpdateError = QryTaticaUpdateError
    Connection = DmConexao.FDConexao
    UpdateOptions.AssignedValues = [uvFetchGeneratorsPoint, uvGeneratorName]
    UpdateOptions.FetchGeneratorsPoint = gpImmediate
    UpdateOptions.GeneratorName = 'SEQ_TAT_CODIGO'
    UpdateOptions.AutoIncFields = 'TAT_CODIGO'
    SQL.Strings = (
  ...
  object QryJogador: TFDQuery
    ...
    OnUpdateError = QryJogadorUpdateError
    Connection = DmConexao.FDConexao
    SQL.Strings = (
  ...
  object QryTecnico: TFDQuery
    AfterInsert = QryTecnicoAfterInsert
    OnUpdateError = QryTecnicoUpdateError
    Connection = DmConexao.FDConexao
    UpdateOptions.AssignedValues = [uvFetchGeneratorsPoint, uvGeneratorName]
    UpdateOptions.FetchGeneratorsPoint = gpImmediate
    UpdateOptions.GeneratorName = 'SEQ_TEC_CODIGO'
    UpdateOptions.AutoIncFields = 'TEC_CODIGO'
    SQL.Strings = (

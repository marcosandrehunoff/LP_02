object DmConexao: TDmConexao
  ...
  object QryMultas: TFDQuery
    ...
    object QryMultasMLT_COND_CODIGO: TIntegerField
      DisplayLabel = 'CODIGO CONDUTOR'
      FieldName = 'MLT_COND_CODIGO'
      Origin = 'MLT_COND_CODIGO'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object QryMultasCOND_NOME: TStringField
      DisplayLabel = 'NOME'
      FieldKind = fkLookup
      FieldName = 'COND_NOME'
      LookupDataSet = QryCondutor
      LookupKeyFields = 'COND_CODIGO'
      LookupResultField = 'COND_NOME'
      KeyFields = 'MLT_COND_CODIGO'
      Size = 50
      Lookup = True
    end
  end
